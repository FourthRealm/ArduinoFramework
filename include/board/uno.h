...
using PinA4  = fw::hal::Pin<fw::hal::internal::PinPortC, 4>;
using PinA5  = fw::hal::Pin<fw::hal::internal::PinPortC, 5>;

// =================== Interrupt Definitions =================== //
using InterruptTrigger = fw::hal::ExternalInterrupt<fw::hal::internal::Interrupt0>::Trigger;
